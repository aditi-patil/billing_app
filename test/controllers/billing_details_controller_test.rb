...
class BillingDetailsControllerTest < ActionController::TestCase
  ...
  test "should create billing_detail" do
    assert_difference('BillingDetail.count') do
      post :create, billing_detail: { amount: @billing_detail.amount, event: @billing_detail.event, location: @billing_detail.location, paid_date: @billing_detail.paid_date }
    end
  ...
  test "should update billing_detail" do
    patch :update, id: @billing_detail, billing_detail: { amount: @billing_detail.amount, event: @billing_detail.event, location: @billing_detail.location, paid_date: @billing_detail.paid_date }
    assert_redirected_to billing_detail_path(assigns(:billing_detail))
  end
